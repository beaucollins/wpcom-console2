...
export const CLEAR_VERSION_ENDPOINT = 'CLEAR_VERSION_ENDPOINT'
...
export const clearSelectedEndpoint = () => ( { type: CLEAR_VERSION_ENDPOINT } )
export const setRequestParam = ( section, name, value ) => ( {
	type: SET_REQUEST_PARAM, section, name, value
} )
